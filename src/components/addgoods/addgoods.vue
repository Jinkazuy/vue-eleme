<template>
    <div id="addgoods">
        ...
        <div class="reduce" @click="reduce" v-if="this.upDataNum"><i class="iconfont">&#xe607;</i></div>
        <div class="goodsnumber"  v-if="this.upDataNum"><span>{{upDataNum}}</span></div>
        <div class="add" @click="addToCart"><i class="iconfont">&#xe604;</i></div>
    </div>
</template>
    ...
    export default {
        ...
        methods: {
            ...
            addToCart(){
                ...
                this.$store.commit("addGoodsToCart", {seller:this.sellername ,goods:[{goodsInfo:this.thisgoodsinfo, num:1}]});
            ...
            reduce(){
                // 同样要把商品信息传过去；
                this.$store.commit("reduceGoodsToCart",{seller:this.sellername ,goods:[{goodsInfo:this.thisgoodsinfo, num:1}]});
            }
        },
        watch: {},
        computed: {
